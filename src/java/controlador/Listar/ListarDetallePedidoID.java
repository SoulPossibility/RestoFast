 ...
 * @author femxn
 */
@WebServlet(name = "ListarDetallePedidoID", urlPatterns = {"/ListarDetallePedidoID"})
public class ListarDetallePedidoID extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listarDetallePedido = detallePedidoDAO.listarDelPedi(pedido_id);
